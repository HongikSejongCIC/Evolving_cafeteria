...
<html>
	...
	<body>
		...
		<form name="login1" method="POST" action="./admin_confirm.jsp" onSubmit="check(); return false">
			ID : <input type="text" name="id" size="10">
			<br /><br />
			Password : <input type="password" name="password" size="10">
			<br /><br />
			<input type="submit" value="로그인"> &nbsp
			<input type="button" value="돌아가기" id="Index" onclick="javascript:history.go(-1);">
		</form>
	</body>
</html>